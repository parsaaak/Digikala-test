        //    user options toggle button
           ...
           document.querySelector("#user-options-toggle").classList.toggle("user-options-affter-toggle")
           document.querySelector("#button").classList.toggle("icon-background-after-toggle")
         }
